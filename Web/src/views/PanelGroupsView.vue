...
const PANEL_PERMISSION_PLAN = [
  {
    ...
    items: [
      ...
      { value: 'panel.files', label: '文件管理', desc: '查看服务器文件列表并读取文件。' },
      { value: 'panel.files.write', label: '文件写入', desc: '编辑、重命名或复制服务器文件。' },
      { value: 'panel.files.delete', label: '文件删除', desc: '删除服务器文件。' },
      { value: 'panel.database', label: '数据库浏览', desc: '浏览 SQLite 数据表。' },
      { value: 'panel.database.write', label: '数据库写入', desc: '通过表格视图新增、修改或删除数据行。' },
      { value: 'panel.database.sql', label: '原始 SQL', desc: '执行原始 SQL 查询或变更。' },
